...
func (wq *WebsiteQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (wq *WebsiteQuery) FirstIDX(ctx context.Context) int {
...
func (wq *WebsiteQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (wq *WebsiteQuery) OnlyIDX(ctx context.Context) int {
...
func (wq *WebsiteQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (wq *WebsiteQuery) IDsX(ctx context.Context) []int {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (wq *WebsiteQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(website.Table, website.Columns, sqlgraph.NewFieldSpec(website.FieldID, field.TypeInt))
	_spec.From = wq.sql
